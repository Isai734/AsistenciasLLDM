package col10dejunio.lldm.asistenciaslldm.model;
...
public class ContratoAsistencia {
     ...
     */
    public final static String AUTORIDAD = "col10dejunio.lldm.asistenciaslldm.model.ProveedorAsistencia";
    /**
    ...
    public static final int MIEMBROS = 3;
    ...
    public static final int MIEMBROS_ID = 8;
    public static final int ASISTENCIAS_ID = 9;
    public static final int MIEMBROS_LISTAS_ID = 10;
    ...
    static {
        ...
        uriMatcher.addURI(AUTORIDAD, MIEMBRO, MIEMBROS);
        uriMatcher.addURI(AUTORIDAD, MIEMBRO + "/#", MIEMBROS_ID);
    ...
    /**
     * Estructura de la tabla INFORME
     */
    ...
    /**
     * Estructura de la tabla PASE_LISTA
     */
